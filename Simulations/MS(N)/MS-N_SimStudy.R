...
truth = list(
  ...
  innov  = c("norm", "norm", "norm"),
  pars   = list("omega_1"=omega, "alpha_1"=alpha, "beta_1"=beta,
                "omega_2"=omega, "alpha_2"=alpha, "gamma_2"=gamma, "beta_2"=beta,
                "omega_3"=omega, "gamma_3"=gamma, "alpha_3"=alpha_Exp, "beta_3"=beta,
                "P_11"=0.8, "P_12"=0.1,
                "P_21"=0.1, "P_22"=0.8,
